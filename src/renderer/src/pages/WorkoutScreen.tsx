        ...
        <div className="root">
            ...
            <div className={`config-screen ${isConfigOpen ? 'open' : ''}`}>
                ...
                <div className="workout-type-selector">
                    <div className={`option ${workoutType === 'Standard' ? 'selected' : ''}`} onClick={() => setWorkoutType('Standard')}>Standard</div>
                    <div className={`option ${workoutType === 'Loading Eccentric' ? 'selected' : ''}`} onClick={() => setWorkoutType('Loading Eccentric')}>Loading Eccentric</div>
                    <div className={`option ${workoutType === 'Dropset' ? 'selected' : ''}`} onClick={() => setWorkoutType('Dropset')}>Dropset</div>
